...
* **ManagedRuntimeVersion**: applicationPools/applicationPoolDefaults/managedRuntimeVersion
* **IdentityType**: applicationPools/applicationPoolDefaults/processModel/identityType
...
* Modified xWebAppPool to allow .NET runtime and identity type specification.
