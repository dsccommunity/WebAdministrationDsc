...
try
{
    InModuleScope -ModuleName $global:DSCResourceName -ScriptBlock {
        ...
        Describe "how $global:DSCResourceName\Get-TargetResource responds to Ensure = 'Present'" {
            ...
            $MockBindingInfo = New-CimInstance `
        ...
        Describe "$global:DSCResourceName\Test-WebsitePath" {
        ...
        Describe "$global:DSCResourceName\Confirm-UniqueBindingInfo" {
