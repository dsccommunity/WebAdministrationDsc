...
- Changes to xWebAdministration
  ...
  - Moved example Sample_EndToEnd_RegisterPhp.ps1 from README.md to its own .ps1 file under `/examples` ([issue #485](https://github.com/PowerShell/xWebAdministration/issues/485))
