...
InModuleScope $script:subModuleName {
    ...
    Describe 'WebAdministration.Common\Get-LocalizedData' {
        $mockTestPath = {
    ...
    Describe 'WebAdministration.Common\New-InvalidResultException' {
    ...
    Describe 'WebAdministration.Common\New-ObjectNotFoundException' {
        Context 'When calling with Message parameter only' {
            It 'Should throw the correct error' {
                $mockErrorMessage = 'Mocked error'
    ...
    Describe 'WebAdministration.Common\New-InvalidOperationException' {
        Context 'When calling with Message parameter only' {
            It 'Should throw the correct error' {
                $mockErrorMessage = 'Mocked error'
    ...
    Describe 'WebAdministration.Common\New-InvalidArgumentException' {
    ...
    Describe 'WebAdministration.Common\Assert-Module' {
        BeforeAll {
    ...
    Describe 'WebAdministration.Common\Compare-ResourcePropertyState' {
    ...
    Describe 'WebAdministration.Common\Find-Certificate' {
